...
namespace BML_TUX.Scripts.UI.Editor {
    public class ScriptHelperWindow : EditorWindow {
        ...
        public string BlockTemplatePath => RelativePathToTemplates + "BlockScriptTemplate.cs";
        public string ExperimentTemplatePath => RelativePathToTemplates + "ExperimentScriptTemplate.cs";
        ...
        public static void ShowWindow() {
            ...
            GetWindow(typeof(ScriptHelperWindow), false, "Script Helper Window");
        }
