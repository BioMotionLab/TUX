...
/// </summary>
public class ComplexExperimentScript : Experiment {
    ...
    public ComplexExperimentScript(ExperimentRunner runner, RunnableDesign runnableDesign) : base(runner, runnableDesign) {
