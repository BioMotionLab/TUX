...
namespace bmlTUX.Data.ScriptingTemplates {
    ...
    /// </summary>
    public class TutorialExperimentScript : Experiment {
        ...
        public TutorialExperimentScript(ExperimentRunner runner, RunnableDesign runnableDesign) : base(runner, runnableDesign) {
